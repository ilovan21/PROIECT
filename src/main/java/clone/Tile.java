...
public class Tile {
	...
	private void drawImage() {
		...
		if (value <= 64) {
			font = clone.Game.main.deriveFont(36f);
			g.setFont(font);
		}
		else {
			font = clone.Game.main;
			g.setFont(font);
		}

		int drawX = WIDTH / 2 - clone.DrawUtils.getMessageWidth("" + value, font, g) / 2;
		int drawY = HEIGHT / 2 + clone.DrawUtils.getMessageHeight("" + value, font, g) / 2;
